function memberInRoom(names, sort) {
  ...
  switch (names.length) {
    case 1:
      return `You and ${a} in this room`;
    case 2:
      return `You, ${a} and ${b} in this room`;
    case 3:
      return `You, ${a}, ${b} and ${c} in this room`;
    default:
      return `You, ${a}, ${b} and ${others.length + 1} others in this room`;
  }
}
...
test(
  memberInRoom(["Bobby", "Robby", "Merry"], "AZ"),
  "You, Bobby, Merry and Robby in this room"
);
test(
  memberInRoom(["Joe", "Lola", "Robert", "Eric", "Carla"], "ZA"),
  "You, Robert, Lola and 3 others in this room"
);
